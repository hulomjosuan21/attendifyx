...
export const roleEnum = pgEnum(
  "department_role_enum",
  Object.values(DepartmentRoleEnum) as [string, ...string[]]
);
...
export const departmentTable = pgTable(
  "departments_table",
  {
    ...
    departmentCreatedAt: timestamp("department_created_at", {
      withTimezone: true,
    })
      .notNull()
      .defaultNow(),
    departmentUpdatedAt: timestamp("department_updated_at", {
      withTimezone: true,
    }).$onUpdateFn(() => new Date()),
  },
  (table) => [
